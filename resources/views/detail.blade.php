                ...
                <div class="col-12 col-md-12 col-lg-5">
                    <div class="card bordered card-form" style="padding: 30px 40px">
                        ...
                        <div class="card-bank d-flex align-items-center justify-content-around">
                            <img src="{{ asset('backend/images/BCA.webp') }}" width="100" alt="logo-bank">
...
@push('script-alt')
    ...
    <script>
        $('#pay-button').click(function (event) {
            ...
            $.ajax({
                url: '/midtrans/transaction', // Ganti dengan URL backend Anda untuk membuat transaksi
                method: 'POST',
                data: {
                    // data transaksi yang diperlukan, sesuaikan dengan kebutuhan Anda
                    travelPackageName: "{{ $travelPackage->name }}",
                    travelPackagePrice: "{{ $travelPackage->price }}"
                },
