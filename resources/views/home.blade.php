...
@section('content')
    <main>
        ...
        <section class="hero" id="hero"
          ...
          height: 100vh;
          background-image: url('http://127.0.0.1:8000/frontend/assets/images/banner.jpg');
        ">
                                ...
                                <a href="{{ route('detail', $travelPackage) }}" class="package-link">
                                    <div class="package-wrapper-img overflow-hidden">
                                        @if (empty($travelPackage->galleries))
                                            <img src="{{ Storage::url('assets/gallery/default.png') }}" class="img-fluid" />
                                        @else
        ...
        <section class="container text-center">
            ...
            <div class="row mt-5">
                <div class="col-12">
                    <iframe width="100%" height="500px" src="https://www.youtube.com/embed/fpAuRRsLycE?controls=1">
                    </iframe>
                </div>
            </div>
        </section>
